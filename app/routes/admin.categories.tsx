...
export async function action({ context, request }: ActionFunctionArgs) {
  ...
  if (action === "create") {
    ...
    try {
      ...
      return json({ error: "カテゴリーの作成に失敗しました" }, { status: 500 });
    }
  }
    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <nav>
          <ul className="admin-sidebar__nav">
            ...
            <li><Link to="/admin/categories" className="active">カテゴリー</Link></li>
      ...
      <main className="admin-content">
        ...
        <div className="admin-form" style={{ marginBottom: "32px" }}>
          <h3 style={{ marginBottom: "20px" }}>新規カテゴリー</h3>
          {actionData?.error && (
          ...
          <Form method="post" style={{ display: "flex", gap: "12px", alignItems: "flex-end" }}>
            ...
            <div className="form-group" style={{ flex: 1, marginBottom: 0 }}>
              ...
              <input type="text" name="slug" id="slug" required placeholder="category-slug" />
            </div>
